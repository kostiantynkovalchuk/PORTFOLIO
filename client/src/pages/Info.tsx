        ...
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl md:text-2xl text-gray-700 leading-relaxed max-w-4xl mx-auto font-bold mb-6">
              "I bring a unique blend of <span className="text-electric-blue">creative thinking, strategic
              leadership, and technical understanding</span> — enabling the <span className="text-electric-blue">translation
              of bold ideas into user-centric solutions</span> across Mobile and Web.
            </p>
            <p className="text-xl md:text-2xl text-gray-700 leading-relaxed max-w-4xl mx-auto font-bold">
              My background spans <span className="text-electric-blue">global environments</span>, where I've led <span className="text-electric-blue">projects
